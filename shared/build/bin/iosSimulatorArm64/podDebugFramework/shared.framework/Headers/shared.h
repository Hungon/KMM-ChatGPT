...
@property (class, readonly, getter=shared) SharedConfig *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *API_KEY __attribute__((swift_name("API_KEY")));
@property (readonly) NSString *BASE_API_URL __attribute__((swift_name("BASE_API_URL")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiClientException")))
@interface SharedApiClientException : SharedKotlinException
...
- (instancetype)initWithError:(SharedErrorResponseError *)error __attribute__((swift_name("init(error:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedErrorResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedErrorResponse *)doCopyError:(SharedErrorResponseError *)error __attribute__((swift_name("doCopy(error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedErrorResponseError *error __attribute__((swift_name("error")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ErrorResponse.Error")))
@interface SharedErrorResponseError : SharedBase
- (instancetype)initWithMessage:(NSString *)message type:(NSString *)type param:(NSString * _Nullable)param code:(NSString * _Nullable)code __attribute__((swift_name("init(message:type:param:code:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedErrorResponseErrorCompanion *companion __attribute__((swift_name("companion")));
- (SharedErrorResponseError *)doCopyMessage:(NSString *)message type:(NSString *)type param:(NSString * _Nullable)param code:(NSString * _Nullable)code __attribute__((swift_name("doCopy(message:type:param:code:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable code __attribute__((swift_name("code")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@property (readonly) NSString * _Nullable param __attribute__((swift_name("param")));
@property (readonly) NSString *type __attribute__((swift_name("type")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ErrorResponse.ErrorCompanion")))
@interface SharedErrorResponseErrorCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedErrorResponseErrorCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChatApiClient")))
@interface SharedChatApiClient : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)completionsContent:(NSString *)content completionHandler:(void (^)(SharedChatCompletionsResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("completions(content:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChatCompletionsResponse")))
@interface SharedChatCompletionsResponse : SharedBase
- (instancetype)initWithId:(NSString *)id object:(NSString *)object created:(int32_t)created choices:(NSArray<SharedChatCompletionsResponseChoice *> *)choices usage:(SharedChatCompletionsResponseUsage *)usage __attribute__((swift_name("init(id:object:created:choices:usage:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedChatCompletionsResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedChatCompletionsResponse *)doCopyId:(NSString *)id object:(NSString *)object created:(int32_t)created choices:(NSArray<SharedChatCompletionsResponseChoice *> *)choices usage:(SharedChatCompletionsResponseUsage *)usage __attribute__((swift_name("doCopy(id:object:created:choices:usage:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedChatCompletionsResponseChoice *> *choices __attribute__((swift_name("choices")));
@property (readonly) int32_t created __attribute__((swift_name("created")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSString *object __attribute__((swift_name("object")));
@property (readonly) SharedChatCompletionsResponseUsage *usage __attribute__((swift_name("usage")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChatCompletionsResponse.Choice")))
@interface SharedChatCompletionsResponseChoice : SharedBase
- (instancetype)initWithIndex:(int32_t)index message:(SharedChatCompletionsResponseChoiceMessage *)message finishReason:(NSString *)finishReason __attribute__((swift_name("init(index:message:finishReason:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedChatCompletionsResponseChoiceCompanion *companion __attribute__((swift_name("companion")));
- (SharedChatCompletionsResponseChoice *)doCopyIndex:(int32_t)index message:(SharedChatCompletionsResponseChoiceMessage *)message finishReason:(NSString *)finishReason __attribute__((swift_name("doCopy(index:message:finishReason:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *finishReason __attribute__((swift_name("finishReason")));
@property (readonly) int32_t index __attribute__((swift_name("index")));
@property (readonly) SharedChatCompletionsResponseChoiceMessage *message __attribute__((swift_name("message")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChatCompletionsResponse.ChoiceCompanion")))
@interface SharedChatCompletionsResponseChoiceCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedChatCompletionsResponseChoiceCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChatCompletionsResponse.ChoiceMessage")))
@interface SharedChatCompletionsResponseChoiceMessage : SharedBase
...
@property (class, readonly, getter=companion) SharedChatCompletionsResponseChoiceMessageCompanion *companion __attribute__((swift_name("companion")));
- (SharedChatCompletionsResponseChoiceMessage *)doCopyRole:(NSString *)role content:(NSString *)content __attribute__((swift_name("doCopy(role:content:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChatCompletionsResponse.ChoiceMessageCompanion")))
@interface SharedChatCompletionsResponseChoiceMessageCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedChatCompletionsResponseChoiceMessageCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChatCompletionsResponse.Companion")))
@interface SharedChatCompletionsResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedChatCompletionsResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChatCompletionsResponse.Usage")))
@interface SharedChatCompletionsResponseUsage : SharedBase
...
@property (class, readonly, getter=companion) SharedChatCompletionsResponseUsageCompanion *companion __attribute__((swift_name("companion")));
- (SharedChatCompletionsResponseUsage *)doCopyPromptTokens:(int32_t)promptTokens completionTokens:(int32_t)completionTokens totalTokens:(int32_t)totalTokens __attribute__((swift_name("doCopy(promptTokens:completionTokens:totalTokens:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChatCompletionsResponse.UsageCompanion")))
@interface SharedChatCompletionsResponseUsageCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedChatCompletionsResponseUsageCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedRequestData : SharedBase
- (instancetype)initWithModel:(NSString *)model messages:(NSArray<SharedRequestDataMessage *> *)messages __attribute__((swift_name("init(model:messages:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedRequestDataCompanion *companion __attribute__((swift_name("companion")));
- (SharedRequestData *)doCopyModel:(NSString *)model messages:(NSArray<SharedRequestDataMessage *> *)messages __attribute__((swift_name("doCopy(model:messages:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedRequestDataMessage *> *messages __attribute__((swift_name("messages")));
@property (readonly) NSString *model __attribute__((swift_name("model")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestData.Companion")))
@interface SharedRequestDataCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRequestDataCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestData.Message")))
@interface SharedRequestDataMessage : SharedBase
- (instancetype)initWithRole:(NSString *)role content:(NSString *)content __attribute__((swift_name("init(role:content:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedRequestDataMessageCompanion *companion __attribute__((swift_name("companion")));
- (SharedRequestDataMessage *)doCopyRole:(NSString *)role content:(NSString *)content __attribute__((swift_name("doCopy(role:content:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *content __attribute__((swift_name("content")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestData.MessageCompanion")))
@interface SharedRequestDataMessageCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRequestDataMessageCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedApiClientKt : SharedBase
@property (class, readonly) SharedKtor_client_coreHttpClient *apiClient __attribute__((swift_name("apiClient")));
@end
